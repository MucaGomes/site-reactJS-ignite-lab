    ...
    return (
        <div className="flex-1">
            ...
            <div className="p-8 max-w-[1100] mx-auto">
                <div className="flex items-starts gap-16">
                    <div className="flex-1">
                 ...
                 <div className="gap-8 mt-20 grid grid-cols-2">
                    ...
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-strech gap-6 hover:bg-gray-600 transition-colors" > 
                        ...
                        <div className="py-6 leading-relaxed">
                            ...
                            <p className="text-sm text-gray-200 mt-2">
                                Acesse o material completo para acelerar o seu desenvolvimento
                            </p>
                        </div>
                    ...
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-strech gap-6 hover:bg-gray-600 transition-colors" > 
                        ...
                        <div className="py-6 leading-relaxed">
                            <strong className="text-2xl">Wallpaperes Exclusivos</strong>
                            <p className="text-sm text-gray-200 mt-2">
